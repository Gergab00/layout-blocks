...
public static function registrerContactsPostType() {
    ...
    public static function newsletterRegister()
    {
        ...
        $inserPost = wp_insert_post($post_data);
 		$res = !is_wp_error( $inserPost ) ? [ 'status' => 1, 'message' => 'You were successfully registered!' ]
		:[ 'status' => 0, 'message' => 'Opps! We make a bo bo.' ];

		wp_send_json($res);
    }

	public static function enqueueScripts(){
		wp_register_script('newsletter_script', BLOCKS_URL .'js/script.js', array('jquery'), '1.0.0', true );
