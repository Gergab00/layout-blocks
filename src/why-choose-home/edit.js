	...
	return (
		<div { ...useBlockProps() }>
			<Panel header="Why Choose Home">
				...
				<PanelBody title="Title and subtitle" initialOpen={ false }>
					<RichText
						tagName="h2"
						className=""
					...
					<RichText
						...
						placeholder="The Text of the subtitle Goes Here"
					/>
				</PanelBody>
				...
				<PanelBody title="Paragraph Text" initialOpen={ false }>
					<InnerBlocks
